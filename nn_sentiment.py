...
# function to turn labels into arrays, used for both tfidf and word embeddings    
...
def prepare_data(training_file, test_file, mode, language_model):
    ...
    return training_data, training_targets, test_data, test_targets, test_labels


def train_test(training_data, training_targets, test_data, test_targets, test_labels, input_n, hidden_n, output_n, lr, epochs):
    ...
    ## save outputs and predictions to file
#     pred_df = pd.DataFrame(all_predictions)
#     pred_df.to_csv(mode+'_'+str(epochs)+'_'+str(hidden_n)+'_.csv')
